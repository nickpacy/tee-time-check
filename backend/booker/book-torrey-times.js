...
async function runMultipleBookings() {
    const bookingParameters = [
        ...
        { time: "2:30pm", courseClass: "1468" }, //North
        { time: "2:00pm", courseClass: "1468" }, //North
        
        { time: "3:15pm", courseClass: "1487" }, //South
        { time: "3:00pm", courseClass: "1487" }, //South
        { time: "2:30pm", courseClass: "1487" }, //South
        { time: "2:00pm", courseClass: "1487" } //South
    ];
